    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(blank=True, null=True, verbose_name='Дата рождения')),
                ('disease', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pages.diagnosis', verbose_name='Диагноз')),
        ...
        migrations.AddField(
            ...
            name='disease',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pages.disease', verbose_name='Название болезни'),
        ),
        migrations.AddField(
            model_name='diagnosis',
            name='veterinarian',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='veterinarian_diagnoses', to=settings.AUTH_USER_MODEL, verbose_name='Ветеринар'),
        ),
        migrations.CreateModel(
            name='Appointment',
            fields=[
